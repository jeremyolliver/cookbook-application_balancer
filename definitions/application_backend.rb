...
# Definition:: application_backend
#
...
define :application_backend, :mode => "http", :balance => "roundrobin" do
  # other options include [:bind, :role_app, :member_options, :mode, :maxconn, :balance, :option, :server] and more
  ...
  node.default['application_balancer']['backend'][params[:name]] = app
end
